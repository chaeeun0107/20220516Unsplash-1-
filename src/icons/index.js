...
export function IconMenu() {
  return (
    <svg width="24" height="24" className="BOTrp" viewBox="0 0 32 32" version="1.1" aria-hidden="false">
...
export function IconSearch() {
  return (
    <svg width="32" height="32" className="DFW_E nT46U VETef" viewBox="0 0 32 32" version="1.1" aria-hidden="false">
...
export function IconPhotoSearch() {
  return (
    <svg width="32" height="32" className="VdNCI nT46U VETef" viewBox="0 0 32 32" version="1.1" aria-hidden="false">
